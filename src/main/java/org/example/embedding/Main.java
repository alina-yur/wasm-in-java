...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        try (Context context = Context.newBuilder().allowAllAccess(true).build()) {
            ...
            System.out.println("Initializing wasm");
            
            context.initialize("wasm");

                context.eval(Source.newBuilder("wasm", Main.class.getResource("factorial.wasm")).build());
                System.out.println("Available members are: " + context.getBindings("wasm").getMemberKeys());
                Value factorial = context.getBindings("wasm").getMember("factorial.wasm").getMember("fac");
